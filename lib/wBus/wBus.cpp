...
void WBus::twi_setAddress(uint8_t address) {
  /*
...
uint8_t WBus::twi_readFrom(uint8_t address, uint8_t* data, uint8_t length) {
  /*
...
uint8_t WBus::twi_writeTo(uint8_t address, uint8_t* data, uint8_t length, uint8_t wait) {
  /*
...
uint8_t WBus::twi_transmit(const uint8_t* data, uint8_t length) {
  /*
...
void WBus::twi_attachSlaveRxEvent( void (*function)(uint8_t*, int) ) {
  /*
...
void WBus::twi_attachSlaveTxEvent( void (*function)(void) ) {
  /*
...
void WBus::twi_reply(uint8_t ack) {
  /*
  * Function twi_reply
...
uint8_t WBus::twi_tout(uint8_t ini) {
