...
/*
    ...
    Converts a I2C String into a relay number and the state to set
    ...
    AA = State of All Relay's


*/

void WBus::I2C_Relay_Setup(int Relay_Begin_Pin, int Relay_End_Pin) {

  _Relay_Begin_Pin = Relay_Begin_Pin;
  _Relay_End_Pin = Relay_End_Pin;

} // END MARKER - I2C_Relay_Setup
...
void WBus::I2C_Relay() {
  ...
  if (_Relay_Begin_Pin == 99) { // 99 = No relay pin set no relays active on this device
    return;
  }

  //  I2C_Receive_Data.indexOf('>', firstClosingBracket + 1 );

  Serial.println("HIT: I2C_Relay");

  //  if (I2C_Receive_Data == String(I2C_Device_ID_Array[x]) + "T") {



  //
  //void I2C_Relay(String Relay_Number_String, int Relay_State, int Relay_Begin_Pin, int Relay_End_Pin) {
  //
